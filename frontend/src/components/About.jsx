          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card key={index} className="p-5 text-center bg-white dark:bg-gray-800 border-blue-200 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300">
